// src/main/java/com/backend/huertohogarbackend/security/config/SecurityConfig.java
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .cors(withDefaults()) // <-- 1. HABILITA CORS EN LA CADENA DE SEGURIDAD
    ...
    // --- 2. CREA LA FUENTE DE CONFIGURACIÓN CORS PARA SPRING SECURITY ---
    @Bean
